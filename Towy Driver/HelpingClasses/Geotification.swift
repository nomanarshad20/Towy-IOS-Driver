...
//  Geotify
//
//  Created by Macbook Pro on 20/04/2022.
//  Copyright © 2022 Cyber Advance Solutions. All rights reserved.
...
extension Geotification {
    ...
    public class func allGeotificationsInRegion() -> [Geotification] {
      guard let savedData = UserDefaults.standard.data(forKey: "savedItemsInHome") else { return [] }
