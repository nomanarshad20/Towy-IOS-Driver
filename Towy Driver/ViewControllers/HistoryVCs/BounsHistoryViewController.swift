//
//  BounsHistoryViewController.swift
//  TOWY Driver
//
...
class BounsHistoryViewController: UIViewController {
...
extension BounsHistoryViewController:UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.lblAmount.text = Constants.Currency + ": \(ds.amount?.rounded() ?? 0)"
    ...
    func tableView(_ tableView: UITableView, willDisplay cell: UITableViewCell, forRowAt indexPath: IndexPath) {
        ...
        cel.lblAmount.text = Constants.Currency + ": \(ds.amount?.rounded() ?? 0)"
